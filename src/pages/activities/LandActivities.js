...
const LandActivities = () => {
  ...
  const filteredActivities = useMemo(() => {
    return allLandEvents.filter(activity => {
      ...
      const matchesCategory = selectedCategory === 'ყველა' || activity.category?.name === selectedCategory;
  ...
  return (
    <Box>
      <Typography variant="h4" fontWeight={700} mb={3} color="primary">
        სახმელეთო აქტივობები
      </Typography>
      <Typography variant="body1" color="text.secondary" mb={4}>
        აღმოაჩინე საუკეთესო სახმელეთო აქტივობები საქართველოში
      </Typography>
                ...
                <Box display="flex" alignItems="center" justifyContent="space-between" mb={2}>
                  <Box display="flex" alignItems="center">
                    ...
                    <Typography variant="h6" color="primary" fontWeight={600}>
                      {activity.base_price ? `${activity.base_price}₾` : activity.discounted_price ? `${activity.discounted_price}₾` : 'ფასი არ არის მითითებული'}
                    </Typography>
                  </Box>
                  <Box display="flex" alignItems="center">
